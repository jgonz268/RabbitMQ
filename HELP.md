...
* The following dependencies are not known to work with Spring Native: 'Cloud Stream, Spring for RabbitMQ'. As a result, your application may not work as expected.
...
```
$ docker run --rm -p 8080:8080 orderrabbitmq:0.0.1-SNAPSHOT
```
